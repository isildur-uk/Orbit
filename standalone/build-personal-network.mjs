...
html = html.replace(/<head>/i, `<head>\n<meta http-equiv="Content-Security-Policy" content="default-src 'none'; script-src 'unsafe-inline' 'unsafe-eval' data: blob: file: 'self'; style-src 'unsafe-inline' data: file: 'self'; img-src data: blob: file: 'self' https://*.cdninstagram.com https://*.fbcdn.net; font-src data: file: 'self'; worker-src blob: data: file: 'self'; connect-src 'self' https://*.cdninstagram.com https://*.fbcdn.net https://vjhahnnulqiouthqovdi.supabase.co wss://vjhahnnulqiouthqovdi.supabase.co https://people.googleapis.com; object-src 'none'; base-uri 'none'; form-action 'self' https://vjhahnnulqiouthqovdi.supabase.co">\n<script>window.ORBIT_OFFLINE_BUILD = true;</script>`);
